...
func (rb *RBACTestSuite) TearDownSuite() {
	rb.session.Cleanup()
}

func (rb *RBACTestSuite) SetupSuite() {
...
func (rb *RBACTestSuite) ValidateListCluster(role string) {
...
func (rb *RBACTestSuite) ValidateListProjects(role string) {
...
func (rb *RBACTestSuite) ValidateCreateProjects(role string) {
...
func (rb *RBACTestSuite) ValidateNS(role string) {
	var checkErr error
...
func (rb *RBACTestSuite) ValidateAddClusterRoles(role string) {
...
func (rb *RBACTestSuite) ValidateAddProjectRoles(role string) {
...
func (rb *RBACTestSuite) ValidateDeleteProject(role string) {
...
func (rb *RBACTestSuite) ValidateRemoveClusterRoles() {
...
func (rb *RBACTestSuite) ValidateRemoveProjectRoles() {
...
func (rb *RBACTestSuite) ValidateListGlobalSettings() {
...
func (rb *RBACTestSuite) ValidateEditGlobalSettings() {
...
func (rb *RBACTestSuite) TestRBAC() {
	tests := []struct {
		name   string
		role   string
		member string
